...
ENV_SYSTEM_KEY_PATH = "SHEETALCHEMY_AUTH_KEY_PATH"
...
def authenticate(key_object: object = None, key_path: str = None) -> None:
    ...
    If none of the parameters are passed, it will look for ENV variable named SHEETALCHEMY_AUTH_KEY_PATH to look for file path
    """
